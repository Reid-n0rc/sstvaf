...
static const golden_t kGolden[] = {
    ...
    { SSTV_MODE_MARTIN3,  "Martin 3",  36, 0, 320, 256, 1, 116974.0, 0.0,  29945344.0 },
    { SSTV_MODE_MARTIN4,  "Martin 4",  32, 1, 320, 256, 1,  62062.0, 0.0,  15887872.0 },
    ...
    { SSTV_MODE_PD240,    "PD 240",    94, 1, 640, 496, 2, 1000000.0, 0.0, 248000000.0 },
    { SSTV_MODE_PD290,    "PD 290",    97, 1, 800, 616, 2, 937280.0, 0.0, 288682240.0 },
};
